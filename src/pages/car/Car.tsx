    ...
    React.useEffect(() => {
        ...
        const loadCarData = async () => {
            if (!car?.brand) {
                ...
                const encodedBrand = location.pathname.split('/')[2];
        ...
        <div className="container">
            <div className="page">
                <BreadCrumpPage
                    links={[
                        { name: 'Главная', url: '/' },
                        { name: 'С пробегом', url: '/cars' },
                        { name: `${brand.name}`, url: `/cars?brand_name=${brand.name}&price_asc=true` },
                        {
                            name: `${model.name}`,
                            url: `/cars?brand_name=${brand.name}&model_name=${model.name}&price_asc=true`,
                        },
                        {

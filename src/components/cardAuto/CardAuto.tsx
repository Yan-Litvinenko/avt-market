...
export const CardAuto = (props: AutoCard & ExtraCardAuto): React.JSX.Element => {
    ...
    const {
        currentImageIndex,
        isSelected,
        handlers: { handleMouseMove, handleCardClick, handleImageClick, handleCreditButtonClick },
            ...
            <section className={styles.card_auto__body}>
                ...
                <div className={styles.card_auto__picture_container}>
                    <img
                        ...
                        alt={`${brand.name} ${year}`}
                    />
                    <div className={styles.card_auto__slider} onClick={() => isMedium && handleImageClick()}>
                        {!isMedium

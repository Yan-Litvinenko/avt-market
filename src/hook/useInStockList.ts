...
import { inStockListSelector, carsSelector } from '../redux/selectors';
...
export const useInStockList = (): UseInStockListReturn => {
    ...
    const listData = React.useMemo(() => {
        ...
        const visibleItems = visibleMore ? inStockList : inStockList.slice(0, 24);
    ...
    }, [inStockList, params, visibleMore]);
